...
resultado = auxiliar.knn(semColuna, y_treino, semColunaTeste, 3, False)
print("Taxa de acerto para 3-NN - SEM PESO: (SEM A ULTIMA COLUNA)", baseDeDados.verificarAcerto(resultado, y_teste))
resultado = auxiliar.knn(semColuna, y_treino, semColunaTeste, 3, True)
...
resultado = auxiliar.knn(semColuna, y_treino, semColunaTeste, 4, False)
print("Taxa de acerto para 4-NN - SEM PESO: (SEM A ULTIMA COLUNA)", baseDeDados.verificarAcerto(resultado, y_teste))
resultado = auxiliar.knn(semColuna, y_treino, semColunaTeste, 4, True)
...
resultado = auxiliar.knn(semColuna, y_treino, semColunaTeste, 5, False)
print("Taxa de acerto para 5-NN - SEM PESO: (SEM A ULTIMA COLUNA)", baseDeDados.verificarAcerto(resultado, y_teste))
resultado = auxiliar.knn(semColuna, y_treino, semColunaTeste, 5, True)
...
resultado = auxiliar.knn(semColuna, y_treino, semColunaTeste, 6, False)
print("Taxa de acerto para 6-NN - SEM PESO: (SEM A ULTIMA COLUNA)", baseDeDados.verificarAcerto(resultado, y_teste))
resultado = auxiliar.knn(semColuna, y_treino, semColunaTeste, 6, True)
...
resultado = auxiliar.knn(semColuna, y_treino, semColunaTeste, 7, False)
print("Taxa de acerto para 7-NN - SEM PESO: (SEM A ULTIMA COLUNA)", baseDeDados.verificarAcerto(resultado, y_teste))
resultado = auxiliar.knn(semColuna, y_treino, semColunaTeste, 7, True)
...
resultado = auxiliar.knn(semColuna, y_treino, semColunaTeste, 8, False)
