...
intervaloIrisSemSegundaETerceira = auxiliar.holdoutSegundaTerceiraColuna(10, 1)
intervaloIrisSemPrimeiraETerceira = auxiliar.holdoutPrimeiraTerceiraColuna(10, 1)

print(f"IRIS COMPLETO: {intervaloIrisCompleto}")
print(f"IRIS SEM PRIMEIRA COLUNA: {intervaloIrisSemPrimeira}")
print(f"IRIS SEM PRIMEIRA E SEGUNDA COLUNA: {intervaloIrisSemPrimeiraESegunda}")
print(f"IRIS SEM SEGUNDA E TERCEIRA COLUNA: {intervaloIrisSemSegundaETerceira}")
print(f"IRIS SEM TERCEIRA E QUARTA COLUNA: {intervaloIrisSemPrimeiraETerceira}")
